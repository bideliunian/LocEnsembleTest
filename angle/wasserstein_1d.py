...
def quantile_function(qs, cws, xs):
    """ Computes the quantile angle of an empirical distribution

    Parameters
    ----------
    qs: array-like, shape (n,)
        Quantiles at which the quantile angle is evaluated
...
def wasserstein_1d(u_values, v_values, u_weights=None, v_weights=None, p=1, require_sort=True):
    ...
    This angle should be preferred to `emd_1d` whenever the backend is
